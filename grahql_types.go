...
var scalars = map[string]qlType{
	...
	"Time":    {Kind: typeKindScalar, Name: h.StrPtr("Time"), Description: h.StrPtr("The Time scalar type references to a ISO 8601 date+time, often used to insert and/or view dates")},
}
